...
if (isset($_POST['mark_all_read'])) {
    $stmt = $pdo->prepare("UPDATE notifications SET read_status = TRUE WHERE user_type = 'admin' AND user_id = ?");
    $stmt->execute([1]); // admin_id = 1
    $notification_msg = "Tüm bildirimler okundu olarak işaretlendi";
    $notification_type = "success";
}

// Admin bildirimlerini getir
$notifications = getAllNotifications($pdo, 'admin', 1, 50);
$unread_count = count(getUnreadNotifications($pdo, 'admin', 1));
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .notification-header { flex-direction: column; gap: 10px; text-align: center; }
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-buttons">
                <a href="admin_orders.php" class="btn btn-secondary">Sipariş Yönetimi</a>
                <a href="admin_panel.php" class="btn btn-primary">Ana Panel</a>
            </div>
        </div>
        ...
        <div class="notifications-section">
                    ...
                    <div class="notification-item <?= !$notif['read_status'] ? 'unread' : '' ?>">
                        ...
                        <div class="notification-actions">
                            ...
                            <?php if (!$notif['read_status']): ?>
                                <a href="notifications.php?mark_read=<?= $notif['id'] ?>" class="mark-read-btn">Okundu İşaretle</a>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>Yeni siparişler ve sistem bildirimleri burada görünecek.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
